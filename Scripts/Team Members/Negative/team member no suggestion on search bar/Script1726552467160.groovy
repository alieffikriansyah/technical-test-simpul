...
'it is better if the search logic in the search bar is given like logic, such as in mysql Like% or %Like%. it makes it easier for users to search'
...
WebUI.verifyElementVisible(findTestObject('Page_FastVisa US Your US Immigration Solution/td_Client(s) not found'))

WebUI.verifyElementVisible(findTestObject('Page_FastVisa US Your US Immigration Solution/td_No Sponsored Employee that can be added'))

WebUI.click(findTestObject('Page_FastVisa US Your US Immigration Solution/button_Cancel'))
