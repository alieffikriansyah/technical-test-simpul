...
WebUI.click(findTestObject('Page_FastVisa US Your US Immigration Solution/button_Manual Entry_btn btn-danger'))

WebUI.click(findTestObject('Page_FastVisa US Your US Immigration Solution/button_Delete'))

WebUI.verifyElementVisible(findTestObject('Page_FastVisa US Your US Immigration Solution/b_The sponsored employee has been successfully removed'))
